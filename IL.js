...
// Cart structure: { barcode: { name, price, quantity } }
let cart = {};
...
function startScanner() {
  ...
  Quagga.init(
    {
      ...
      decoder: {
        // Supports common retail barcodes. Add/remove as needed.
        readers: [
          "ean_reader",
          "ean_8_reader",
          "code_128_reader",
  ...
  Quagga.onDetected(function (result) {
    ...
    // Visual feedback: briefly border glow
    const cam = document.querySelector(".camera");
    cam.style.boxShadow = "0 0 0 4px rgba(46,125,50,0.5)";
    setTimeout(() => (cam.style.boxShadow = "none"), 250);
  });
}
